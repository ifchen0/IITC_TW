...
window.getModDetails = function(d) {
  ...
  for (var i=0; i<mods.length; i++) {
    ...
    if      (mods[i] == '常見 門泉護盾')     modImage = '@@INCLUDEIMAGE:images/mods/CS.png@@';
    else if (mods[i] == '罕見 門泉護盾')     modImage = '@@INCLUDEIMAGE:images/mods/RS.png@@';
    else if (mods[i] == '十分罕見 門泉護盾') modImage = '@@INCLUDEIMAGE:images/mods/VRS.png@@';
