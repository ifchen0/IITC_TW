...
// @version        0.26.0.20161006.121049
...
// @description    [Release-2016-10-06-121049] Total conversion for the ingress intel map.
...
window.iitcBuildDate = '2016-10-06-121049';
...
document.getElementsByTagName('body')[0].innerHTML = ''
  ...
  + '      <img src="data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAYAAACNiR0NAAAAVElEQVR42mNgIBZ8/v+fgaqALANBmtAxNgPxqSPaFWTJ0dVAssIXXQJbWGELM6IdQqyBFMU6UQbi0kDIQKpYNDBeplks0zwdDs6sR9XSZvAXsFQAAEwpNOmMKNo3AAAAAElFTkSuQmCC"/ title="目前位置" id="buttongeolocation">'
...
function boot() {
  ...
  console.log('loading done, booting. Built: 2016-10-06-121049');
...
window.getMarkerStyleOptions = function(details) {
  ...
  var LEVEL_TO_WEIGHT = [1, 2, 2, 2, 2, 3, 3, 3, 4];
  var LEVEL_TO_RADIUS = [5, 5, 5, 5, 5, 6, 6, 7, 8];
...
window.renderUpdateStatus = function() {
  ...
  if (tileParams.hasPortals) {
    ...
    if (tileParams.minLinkLength > 0)
      //iF:Adjust color to background color.
      t += '<span id="loadlevel">&gt;'+(tileParams.minLinkLength>1000?tileParams.minLinkLength/1000+'公里':tileParams.minLinkLength+'公尺')+'</span>';
    else
      //iF:Adjust color to background color.
      t += '<span id="loadlevel">所有連線</span>';
  }
...
var script = document.createElement('script');
var info = { buildName: 'Release', dateTimeVersion: '20161006.121049' };
