...
// @version        0.25.2.20151008.145611
...
// @description    [local-2015-10-08-145611] Total conversion for the ingress intel map.
...
window.iitcBuildDate = '2015-10-08-145611';
...
function boot() {
  ...
  console.log('loading done, booting. Built: 2015-10-08-145611');
...
window.getModDetails = function(d) {
  ...
  $.each(d.mods, function(ind, mod) {
    ...
    if (mod) {
      ...
      if      (modName === 'Portal Shield')      modName = '門泉護盾';
  ...
  for (var i=0; i<mods.length; i++) {
	...
	else modImage = 'data:image/png;base64,';
...
var script = document.createElement('script');
var info = { buildName: 'local', dateTimeVersion: '20151008.145611' };
